// پارس دیتای بازار TSETMC — بدون وابستگی به سرور (قابل استفاده در مرورگر هم هست)
...
export const TSETMC_URLS = [
  ...
  "https://cdn.tsetmc.com/api/ClosingPrice/GetMarketWatch?market=0&paperTypes[0]=0&showTraded=false&withBestLimits=true",
...
export function buildCallOptions(raw: string): OptionRow[] {
  const parts = raw.split("@");
  if (parts.length < 4) throw new Error("پاسخ نامعتبر از سرور بورس");
